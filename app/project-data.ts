...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: { he: "לחץ אנכי", en: "Vertical Pressure" },
    eyebrow: { he: "Social Campaign", en: "Social Campaign" },
    category: "social",
    field: { he: "קמפיין סושיאל", en: "Social Campaign" },
    client: "AppsFlyer",
    service: { he: "בימוי · Motion · עריכה", en: "Direction · Motion · Edit" },
    year: "2025",
    video: "/media/green-geometry-vertical.mp4",
    poster: "/media/green-geometry-vertical.jpg",
    statement: {
      he: "מסך אנכי הוא במה — לא גרסה חתוכה של משהו רחב יותר.",
      en: "A vertical screen is a stage — not a cropped version of something wider.",
    },
    challenge: {
      he: "לתפוס תשומת לב מיד ולשמור על רעיון ברור גם בצפייה ללא סאונד.",
      en: "Catch attention immediately and keep the idea clear with the sound off.",
    },
    approach: {
      he: "קומפוזיציה, טיפוגרפיה וקצב שנבנו מראש למסך אנכי וללולאות קצרות.",
      en: "Composition, typography and rhythm designed for vertical screens and short loops.",
    },
    result: {
      he: "מערכת סושיאל חדה וגמישה שממשיכה לעבוד גם בין קמפיינים.",
      en: "A sharp, flexible social system that keeps working between campaigns.",
    },
    layout: "vertical",
    accent: "#b3e400",
  },
